# Suma de nodos en arbol (Problema 30)
...
Dado un árbol binario $T$ cuyas llaves son números enteros, realice la suma de todos los elementos del árbol utilizando algún recorrido de árboles, por ejemplo pre orden, entre orden o post orden.

### Salida

Imprima el resultado de sumar todos las llaves del árbol $T$.
