...
Sea $T$ un árbol binario se define por altura máxima $h$ de $T$, a la cantidad de nodos que tiene el camino simple más largo desde la raíz hasta una hoja. Dado un árbol binario $T$ halle su altura máxima $h$.
